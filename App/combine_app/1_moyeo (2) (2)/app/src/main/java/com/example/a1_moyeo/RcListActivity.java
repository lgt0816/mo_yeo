...
public class RcListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //리스트 클릭 시 rclook.xml로 넘어감
         rcslistview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                ...
                intent.putExtra("rc_title",rc_s_title);
                intent.putExtra("rc_subtitle",rc_s_subtitle);
        ...
        //리스트 클릭 시 rclook.xml로 넘어감
        rcclistview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                String rc_c_title = rcctitle[position];
                String rc_c_subtitle = rccgrade[position];
                Intent intent = new Intent(getApplicationContext(),RcLookActivity.class);
                intent.putExtra("rc_title",rc_c_title);
                intent.putExtra("rc_subtitle",rc_c_subtitle);
                startActivity(intent);
            }
        });
        ...
        rcplistview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                String rc_p_title = rcptitle[position];
                String rc_p_subtitle = rcpgrade[position];
                Intent intent = new Intent(getApplicationContext(),RcLookActivity.class);
                intent.putExtra("rc_title",rc_p_title);
                intent.putExtra("rc_subtitle",rc_p_subtitle);
                startActivity(intent);
            }
        });
