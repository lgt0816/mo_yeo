...
//1활동제목,2학년,3활동type,4진행날짜(시작),5진행날짜(끝)
        ...
        ///리스트 클릭 시 세부사항 ui로 넘어감( > finishlook.xml)
        s2listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                String s_2t = s_2title[position];
                String s_2s = s_2sub[position];
                Intent intent = new Intent(getApplicationContext(),FinishLookActivity.class);
                intent.putExtra("title",s_2t);
                intent.putExtra("Sub",s_2s);
                startActivity(intent);
            }
        });
        //c2listview
        ...
        ///리스트 클릭 시 세부사항 ui로 넘어감( > finishlook.xml)
        c2listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                String c_2t = c_2title[position];
                String c_2s = c_2sub[position];
                Intent intent = new Intent(getApplicationContext(),FinishLookActivity.class);
                intent.putExtra("title",c_2t);
                intent.putExtra("Sub",c_2s);
                startActivity(intent);
            }
        });
        //p2listview
        ...
        p2listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                String p_2t = p_2title[position];
                String p_2s = p_2sub[position];
                Intent intent = new Intent(getApplicationContext(),FinishLookActivity.class);
                intent.putExtra("title",p_2t);
                intent.putExtra("Sub",p_2s);
                startActivity(intent);
            }
        });
        //sp2listview
        ...
        ///리스트 클릭 시 세부사항 ui로 넘어감( > finishlook.xml)
        sp2listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                String sp_2t = sp_2title[position];
                String sp_2s = sp_2sub[position];
                Intent intent = new Intent(getApplicationContext(),FinishLookActivity.class);
                intent.putExtra("title",sp_2t);
                intent.putExtra("Sub",sp_2s);
                startActivity(intent);
            }
        });
        ...
        s3listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                String s_3t = s_3title[position];
                String s_3s = s_3sub[position];
                Intent intent = new Intent(getApplicationContext(),FinishLookActivity.class);
                intent.putExtra("title",s_3t);
                intent.putExtra("Sub",s_3s);
                startActivity(intent);
            }
        });
        //c3listview
        ...
        ///리스트 클릭 시 세부사항 ui로 넘어감( > finishlook.xml)
        c3listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                String c_3t = c_3title[position];
                String c_3s = c_3sub[position];
                Intent intent = new Intent(getApplicationContext(),FinishLookActivity.class);
                intent.putExtra("title",c_3t);
                intent.putExtra("Sub",c_3s);
                startActivity(intent);
            }
        });
        //p3listview
        ...
        ///리스트 클릭 시 세부사항 ui로 넘어감( > finishlook.xml)
        p3listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                String p_3t = p_3title[position];
                String p_3s = p_3sub[position];
                Intent intent = new Intent(getApplicationContext(),FinishLookActivity.class);
                intent.putExtra("title",p_3t);
                intent.putExtra("Sub",p_3s);
                startActivity(intent);
            }
        });
        //sp3listview
        ...
        ///리스트 클릭 시 세부사항 ui로 넘어감( > finishlook.xml)
        sp3listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                String sp_3t = sp_3title[position];
                String sp_3s = sp_3sub[position];
                Intent intent = new Intent(getApplicationContext(),FinishLookActivity.class);
                intent.putExtra("title",sp_3t);
                intent.putExtra("Sub",sp_3s);
                startActivity(intent);
            }
        });
        ...
        ///리스트 클릭 시 세부사항 ui로 넘어감( > finishlook.xml)
        s4listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                String s_4t = s_4title[position];
                String s_4s = s_4sub[position];
                Intent intent = new Intent(getApplicationContext(),FinishLookActivity.class);
                intent.putExtra("title",s_4t);
                intent.putExtra("Sub",s_4s);
                startActivity(intent);
            }
        });
        //c4listview
        ...
        ///리스트 클릭 시 세부사항 ui로 넘어감( > finishlook.xml)
        c4listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                String c_4t = c_4title[position];
                String c_4s = c_4sub[position];
                Intent intent = new Intent(getApplicationContext(),FinishLookActivity.class);
                intent.putExtra("title",c_4t);
                intent.putExtra("Sub",c_4s);
                startActivity(intent);
            }
        });
        //p4listview
        ...
        ///리스트 클릭 시 세부사항 ui로 넘어감( > finishlook.xml)
        p4listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                String p_4t = p_4title[position];
                String p_4s = p_4sub[position];
                Intent intent = new Intent(getApplicationContext(),FinishLookActivity.class);
                intent.putExtra("title",p_4t);
                intent.putExtra("Sub",p_4s);
                startActivity(intent);
            }
        });
        ...
        ///리스트 클릭 시 세부사항 ui로 넘어감( > finishlook.xml)
        g4listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                String g_4t = g_4title[position];
                String g_4s = g_4sub[position];
                Intent intent = new Intent(getApplicationContext(),FinishLookActivity.class);
                intent.putExtra("title",g_4t);
                intent.putExtra("Sub",g_4s);
                startActivity(intent);
            }
        });
        //sp4listview
        ...
        ///리스트 클릭 시 세부사항 ui로 넘어감( > finishlook.xml)
        sp4listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                String sp_4t = sp_4title[position];
                String sp_4s = sp_4sub[position];
                Intent intent = new Intent(getApplicationContext(),FinishLookActivity.class);
                intent.putExtra("title",sp_4t);
                intent.putExtra("Sub",sp_4s);
                startActivity(intent);
            }
        });
