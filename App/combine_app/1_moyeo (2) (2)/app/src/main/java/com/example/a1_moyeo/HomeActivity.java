...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView Myinfo_gradu = (TextView)findViewById(R.id.myinfo_gradu);
        TextView Myinfo_number = (TextView)findViewById(R.id.myinfo_number);
        TextView Myinfo_email = (TextView)findViewById(R.id.myinfo_email);


        Intent intent = getIntent();
        String rcv1 = intent.getStringExtra("getdata");
        String[] splictselectdata =rcv1.split("ㅩ");
        Myinfo_name.setText(splictselectdata[3]); //name
        Myinfo_gradu.setText(splictselectdata[8]);
        Myinfo_number.setText(splictselectdata[1]);
        Myinfo_email.setText(splictselectdata[6]);
